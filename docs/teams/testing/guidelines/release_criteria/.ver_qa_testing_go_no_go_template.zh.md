---
title: Rocky Linux TBD QA 与测试 GO / NO GO 状态
...
# {{ rc.prod }} {{ rc.ver }} QA 与测试：GO / NO GO 状态
本文档从 QA / 测试工作的角度总结了 Rocky Linux 8.6 发布的 GO / NO GO 状态。它主要基于发布标准 (https://wiki.rockylinux.org/team/testing/release_criteria/) 编写，最初是从该文档导入的。如果正式发布标准文档与本文档之间存在差异，以正式发布标准文档为准，本文档应随之更新。
